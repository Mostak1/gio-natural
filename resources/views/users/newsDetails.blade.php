...
@section('title', 'News-Gio-Natural')
@section('content')
<!-- breadcrumb-section -->
            ...
            <div class="col-lg-4">
                <div class="sidebar-section">
                    <div class="recent-posts">
                        <h4>Recent Posts</h4>
                        <ul>
                            <li><a href="{{ url('newsDetails') }}">You will vainly look for fruit on it in autumn.</a></li>
                            <li><a href="{{ url('newsDetails') }}">A man's worth has its season, like tomato.</a></li>
                            <li><a href="{{ url('newsDetails') }}">Good thoughts bear good fresh juicy fruit.</a></li>
                            <li><a href="{{ url('newsDetails') }}">Fall in love with the fresh orange</a></li>
                            <li><a href="{{ url('newsDetails') }}">Why the berries always look delecious</a></li>
                        </ul>
                    </div>
                    <div class="archive-posts">
                        <h4>Archive Posts</h4>
                        <ul>
                            <li><a href="{{ url('newsDetails') }}">JAN 2019 (5)</a></li>
                            <li><a href="{{ url('newsDetails') }}">FEB 2019 (3)</a></li>
                            <li><a href="{{ url('newsDetails') }}">MAY 2019 (4)</a></li>
                            <li><a href="{{ url('newsDetails') }}">SEP 2019 (4)</a></li>
                            <li><a href="{{ url('newsDetails') }}">DEC 2019 (3)</a></li>
                        </ul>
                    </div>
                    <div class="tag-section">
                        <h4>Tags</h4>
                        <ul>
                            <li><a href="{{ url('newsDetails') }}">Apple</a></li>
                            <li><a href="{{ url('newsDetails') }}">Strawberry</a></li>
                            <li><a href="{{ url('newsDetails') }}">BErry</a></li>
                            <li><a href="{{ url('newsDetails') }}">Orange</a></li>
                            <li><a href="{{ url('newsDetails') }}">Lemon</a></li>
                            <li><a href="{{ url('newsDetails') }}">Banana</a></li>
                        </ul>
                    </div>
                </div>
            </div>
