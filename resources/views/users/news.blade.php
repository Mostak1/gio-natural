...
<div class="latest-news mt-150 mb-150">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-latest-news">
                    <a href="{{ url('newsDetails')}}"><div class="latest-news-bg news-bg-4"></div></a>
                    <div class="news-text-box">
                        <h3><a href="{{ url('newsDetails')}}">Fall in love with the fresh orange</a></h3>
                        <p class="blog-meta">
                            <span class="author"><i class="fas fa-user"></i> Admin</span>
                            <span class="date"><i class="fas fa-calendar"></i> 27 December, 2019</span>
                        </p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-latest-news">
                    <a href="{{ url('newsDetails')}}"><div class="latest-news-bg news-bg-5"></div></a>
                    <div class="news-text-box">
                        <h3><a href="{{ url('newsDetails')}}">Why the berries always look delecious</a></h3>
                        <p class="blog-meta">
                            <span class="author"><i class="fas fa-user"></i> Admin</span>
                            <span class="date"><i class="fas fa-calendar"></i> 27 December, 2019</span>
                        </p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-latest-news">
                    <a href="{{ url('newsDetails')}}"><div class="latest-news-bg news-bg-6"></div></a>
                    <div class="news-text-box">
                        <h3><a href="{{ url('newsDetails')}}">Love for fruits are genuine of John Doe</a></h3>
                        <p class="blog-meta">
                            <span class="author"><i class="fas fa-user"></i> Admin</span>
